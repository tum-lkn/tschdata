    ...
    for l=1:5
        ...
        if freq_dumbinthop(j,l+1)~=0
            ...
            elseif retx_dumbinthop(j,l)==2
                packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
                packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
                packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
            elseif retx_dumbinthop(j,l)==1
                packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
                packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
                packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;                
                packetcount(sqn(mod(i+13,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))=packetcount(sqn(mod(i+13,16)+1)-10,hopaddr_dumbinthop(j,l),hopaddr_dumbinthop(j,l+1))+1;
            end             
        else
            if retx_dumbinthop(j,l)==3
            ...
            elseif retx_dumbinthop(j,l)==2
                packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)=packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)+1;
                packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)=packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)+1;
                packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),1)=packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),1)+1;
            elseif retx_dumbinthop(j,l)==1
                packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)= packetsuc(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)+1;
                packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)=packetcount(freq_dumbinthop(j,l)-10,hopaddr_dumbinthop(j,l),1)+1;
                packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),1)=packetcount(sqn(mod(i+14,16)+1)-10,hopaddr_dumbinthop(j,l),1)+1;                
                packetcount(sqn(mod(i+13,16)+1)-10,hopaddr_dumbinthop(j,l),1)=packetcount(sqn(mod(i+13,16)+1)-10,hopaddr_dumbinthop(j,l),1)+1;
            end               
        end
...
%Hobj= HeatMap(1-maindest(:,2:12),'ColorMap',redbluecmap,'RowLabels',11:26,'ColumnLabels',2:12);
%view(Hobj);
%addXLabel(Hobj);
%addYLabel(Hobj);
%plot(Hobj);
...
%print(fig,'heatmapmedsharedlowint','-dpdf','-r0')
